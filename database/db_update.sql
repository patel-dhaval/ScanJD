...
INSERT INTO `unverified` VALUES ('+17165909170','d9ef9b','test1@gmail.com','DhavalP');
...
CREATE TABLE `WaitlistUsers` (
  ...
  `emailDSateTime` datetime DEFAULT NULL,
  PRIMARY KEY (`phone`,`email`),
  UNIQUE KEY `phone_UNIQUE` (`phone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `WaitlistUsers` VALUES ('DhavalP','+17165909170','dhavaljp1595@gmail.com','2023-09-26 03:07:34',0,NULL);
...
-- Dump completed on 2023-09-26 17:52:40
